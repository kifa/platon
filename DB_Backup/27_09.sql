...
(7,	'kt@gmail.com',	'Jiráskova 182',	18271,	'České Budějovice',	NULL),
(8,	'soucek@bohumil.cz',	'U fabriky 1888',	18271,	'Ostrava',	NULL),
(9,	'kalinka@mail.cz',	'Zoologická 288',	192811,	'Liberec',	NULL),
(10,	'smalik@yahoo.com',	'Mala 182',	11177,	'Praha',	NULL),
(11,	'chudas@atlas.cz',	'Italská 123',	18299,	'Brno',	NULL);
...
CREATE TABLE `banner` (
  ...
  `BannerType` varchar(100) COLLATE utf8_bin NOT NULL,
  `BannerValue` text COLLATE utf8_bin NOT NULL,
  `BannerLink` text COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`BannerID`),
  KEY `BannerTypeID` (`BannerType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `banner` (`BannerID`, `BannerType`, `BannerValue`, `BannerLink`) VALUES
(1,	'slider1',	'slide2.jpg',	''),
(2,	'slider2',	'slide4.jpg',	''),
...
CREATE TABLE `bannertype` (
  ...
  `BannerTypeCode` varchar(100) COLLATE utf8_bin NOT NULL,
  `BannerTypeName` varchar(100) COLLATE utf8_bin NOT NULL,
  `BannerTypeDescription` text COLLATE utf8_bin NOT NULL,
...
(8,	2,	'pavlinka19@gmail.com',	100,	0,	20,	80,	100,	'2013-09-22 21:23:45',	'2013-09-22 21:23:45',	NULL,	1,	1,	NULL,	NULL,	NULL,	1),
(9,	1,	'kt@gmail.com',	40,	99,	8,	32,	139,	'2013-09-22 21:35:34',	'2013-09-22 21:35:34',	NULL,	2,	1,	NULL,	NULL,	NULL,	0),
(10,	1,	'soucek@bohumil.cz',	40500,	160,	8100,	32400,	40660,	'2013-09-22 21:36:53',	'2013-09-22 21:36:53',	NULL,	3,	1,	NULL,	NULL,	NULL,	0),
(11,	1,	'kalinka@mail.cz',	30,	0,	6,	24,	30,	'2013-09-22 21:38:03',	'2013-09-22 21:38:03',	NULL,	1,	1,	NULL,	NULL,	NULL,	0),
(12,	1,	'smalik@yahoo.com',	38,	160,	7.6,	30.4,	198,	'2013-09-22 21:39:09',	'2013-09-22 21:39:09',	NULL,	3,	1,	NULL,	NULL,	NULL,	0),
(13,	1,	'chudas@atlas.cz',	13545,	0,	2709,	10836,	13545,	'2013-09-22 21:40:21',	'2013-09-22 21:40:21',	NULL,	1,	1,	NULL,	NULL,	NULL,	1);
...
(98,	'photoalbum',	'slide4.jpg',	31,	'photoalbum',	NULL);
...
(31,	'About us',	'',	NULL,	NULL,	2),
(32,	'About us',	'',	NULL,	NULL,	2);
...
(22,	'Klatch Coffee - Blue Thunder Blend',	'Klatch Coffee - Blue Thunder Blend',	NULL,	NULL,	3,	'11111',	'A strong, rich cup with characteristic smokey, sweet tones. A full bodied cup resulting from a combination of our French Roast cut with a full city roast Sumatra Blue Lintong. ',	'A strong, rich cup with characteristic smokey, sweet tones. A full bodied cup resulting from a combination of our French Roast cut with a full city roast Sumatra Blue Lintong.&nbsp;',	3,	'123456',	'122',	'rok',	9,	1007,	'0000-00-00',	'2013-09-12 21:39:35',	NULL),
...
(41,	'Klatch Coffee - Blue Thunder Blend',	'Klatch Coffee - Blue Thunder Blend',	22,	'200g',	3,	'11111',	'A strong, rich cup with characteristic smokey, sweet tones. A full bodied cup resulting from a combination of our French Roast cut with a full city roast Sumatra Blue Lintong. ',	'A strong, rich cup with characteristic smokey, sweet tones. A full bodied cup resulting from a combination of our French Roast cut with a full city roast Sumatra Blue Lintong.&nbsp;',	1,	'123456',	'122',	'rok',	1,	1007,	'0000-00-00',	'2013-09-23 00:35:01',	NULL);
...
(2,	'About us',	'<p style=\"margin: 0px 0px 14px; padding: 0px;\">Suspendisse pellentesque ut orci eget porttitor. Curabitur placerat odio et mauris consectetur elementum. Aliquam dictum eros id ultricies iaculis. Donec non orci facilisis, interdum nisi vel, imperdiet justo. Nam imperdiet diam eget quam vehicula, a mattis orci scelerisque. Morbi tincidunt molestie enim non malesuada. Aliquam scelerisque mi non mauris dictum viverra. In tincidunt, ante ac hendrerit scelerisque, odio quam suscipit nulla, sed tempor nisl purus at nisl. Ut blandit eu erat sed facilisis. Sed facilisis id ipsum ac placerat. Vivamus eu arcu tempus, vulputate massa vel, dignissim estLorem ipsum dolor sit amet, consectetur adipiscing elit. In ut purus feugiat, tincidunt nibh nec, faucibus massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed pulvinar risus quis diam tempor volutpat quis non lacus. Donec ullamcorper pellentesque lacinia. Integer lobortis tortor nec elit adipiscing suscipit. Nulla nec dolor ac lacus facilisis mollis at eu risus. Etiam ac congue mi. Nam nec malesuada lorem, a interdum risus. Aliquam at tellus ac nulla sodales ultricies eu convallis nisi. Quisque et magna bibendum, cursus purus suscipit, pellentesque libero. Proin ac lacinia augue, aliquet dictum metus. Nam non felis lectus. Donec a sapien eu nunc vestibulum varius vitae ac odio. Vestibulum fermentum sem ut dui blandit consequat.<br></p><p style=\"margin: 0px 0px 14px; padding: 0px;\"><img src=\"http://localhost/platon/www/images/static/31/l-slide4.jpg\" class=\"textImg\" style=\"margin: 10px 10px 10px 0px;\">Fusce placerat nulla tortor, id gravida lectus hendrerit ac. Sed mattis ultrices ornare. Nulla urna turpis, mattis vitae lectus nec, blandit consequat orci. Nullam mi neque, sodales vulputate venenatis rhoncus, rhoncus sit amet dui. Fusce et diam euismod, blandit metus eget, ornare purus. Nunc ut erat a justo consectetur accumsan vel et metus. Donec in porttitor nisl. Maecenas felis dolor, euismod nec gravida nec, hendrerit vel ligula. Ut dictum, diam ac sagittis commodo, quam metus volutpat ante, eget fringilla dolor massa a ligula. Aliquam sit amet euismod dui, vitae egestas elit. Donec scelerisque viverra condimentum. Aliquam felis ligula, tempus quis laoreet non, fringilla eget urna. Nulla at magna laoreet, viverra diam eget, mollis nisi.</p><p style=\"margin: 0px 0px 14px; padding: 0px;\">Suspendisse eros felis, tincidunt ac congue at, scelerisque a lectus. Etiam sollicitudin magna ac sem faucibus mollis. Morbi viverra cursus elit nec luctus. Phasellus eget metus eu est tincidunt varius. Aliquam ullamcorper enim malesuada orci consectetur, vel ultricies massa facilisis. Quisque mi odio, blandit sed nisl non, dapibus ornare nibh. Integer ut erat sit amet urna accumsan porta ac non sapien. Vestibulum tellus eros, fermentum a rutrum non, semper a felis.&nbsp;</p><p style=\"margin: 0px 0px 14px; padding: 0px;\">Praesent venenatis lorem tincidunt, laoreet metus eget, dapibus ligula. Sed convallis sapien vel vestibulum semper. Cras rhoncus elementum sapien, vel porta dolor tristique at. Curabitur gravida id urna sit amet lobortis. Donec quis risus sapien.</p><p style=\"margin: 0px 0px 14px; padding: 0px;\">In mollis mauris ut
uere justo eu, dignissim erat. Praesent ornare, quam at sollicitudin aliquet, ipsum felis dapibus turpis, ac porttitor turpis elit vitae magna. Duis vitae ipsum tincidunt, fringilla mi mollis, tristique ipsum. Proin non commodo augue. Cras mi turpis, egestas sed laoreet eget, iaculis et turpis. Curabitur congue eu nibh eu laoreet. Duis at sollicitudin est.\r\n\r\nAliquam iaculis ultricies metus non volutpat. Proin tempus fringilla nisi. In a elementum odio. Nulla vulputate sapien eu purus tincidunt consequat. Sed id est libero. Ut sit amet porta neque, at consequat nunc. Sed libero metus, volutpat et nulla sed, iaculis dapibus mauris.\r\n\r\nAliquam erat volutpat. Aenean in leo quam. Maecenas eget ullamcorper sapien, eu pellentesque nulla. Donec at erat mollis, auctor magna non, fermentum diam. Nullam nisi arcu, tincidunt a arcu mollis, elementum sodales neque. Aliquam vestibulum, purus a auctor pellentesque, tellus dolor varius arcu, at mattis leo ligula vel lacus. Nullam elit sapien, elementum id sem nec, eleifend sodales justo. Donec eleifend faucibus risus, non auctor mauris semper auctor. Fusce lacinia ac sapien vitae tristique. Nunc bibendum turpis nibh, sit amet venenatis elit tempor feugiat. Quisque porttitor accumsan pretium.\r\n\r\nVivamus luctus vitae dui a ultricies. Nam feugiat arcu ut nisl posuere tincidunt. In dapibus tortor a lorem mattis fermentum. Praesent feugiat nisl magna. Integer cursus lobortis tortor et iaculis. Aliquam justo mauris, semper vestibulum nisl sit amet, sollicitudin tincidunt tortor. Integer mollis est vitae ullamcorper sodales. Sed tempus mollis purus vel cursus. Curabitur mattis consectetur egestas. Sed scelerisque at nibh sit amet luctus. Mauris sagittis diam nisl, sed condimentum purus varius sed. Suspendisse in ultrices sem. Duis dolor dolor, scelerisque et felis facilisis, porta tempor est.\r\n\r\nCras nec justo a eros vestibulum condimentum eu et tortor. Sed elementum aliquet odio, sit amet viverra arcu venenatis non. Praesent sodales turpis eget urna interdum rutrum. Curabitur molestie hendrerit purus, vitae convallis dui. Integer bibendum lorem ut dapibus dictum. Quisque nec mollis mauris, quis tincidunt elit. Duis malesuada turpis vel augue ultricies imperdiet. Nulla neque leo, interdum id dui a, sollicitudin volutpat neque.',	2);
...
('chudas@atlas.cz',	NULL,	'Tomáš Chudý',	81182111,	NULL,	NULL,	'user'),
...
('kalinka@mail.cz',	NULL,	'Alexandr Kalinka',	111231211,	NULL,	NULL,	'user'),
('kk@karel.cz',	NULL,	'Karel Krčma',	812811111,	NULL,	NULL,	'user'),
('kt@gmail.com',	NULL,	'Karolína Tmavá',	999182111,	NULL,	NULL,	'user'),
('pavlinka19@gmail.com',	NULL,	'Pavla Pokorna',	321987654,	NULL,	NULL,	'user'),
('smalik@yahoo.com',	NULL,	'Sam Malik',	88171221,	NULL,	NULL,	'user'),
('soucek@bohumil.cz',	NULL,	'Bohumil Souček',	732512127,	NULL,	NULL,	'user'),
...
CREATE TABLE `video` (
  ...
  `BlogID` int(11) DEFAULT NULL,
  `StaticTextID` int(11) DEFAULT NULL,
  `VideoName` varchar(255) COLLATE utf8_czech_ci NOT NULL,
  `VideoLink` text COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`VideoID`),
  KEY `ProductID` (`ProductID`),
  KEY `BlogID` (`BlogID`),
  KEY `StaticTextID` (`StaticTextID`),
