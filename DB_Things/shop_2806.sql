...
(1001,	'Cellphone',	'<p>A mobile phone (also known as a cellular phone, cell phone, and a hand phone) is a device that can make and receive telephone calls over a radio link while moving around a wide geographic area. It does so by connecting to a cellular network provided by a mobile phone operator, allowing access to the public telephone network. By contrast, a cordless telephone is used only within the short range of a single, private base station. In addition to telephony, modern mobile phones also support a wide variety of other services such as text messaging, MMS, email, Internet access, short-range wireless communications (infrared, Bluetooth), business applications, gaming and photography. Mobile phones that offer these and more general computing capabilities are referred to as smartphones.</p>',	1,	NULL,	NULL),
...
(1003,	'Smartphones',	NULL,	NULL,	NULL,	NULL),
...
(1,	'Samsung Galaxy Nexus 2',	3,	'',	NULL,	'<p>Smartphone ze serie Nexus</p>',	1,	'',	'',	'',	10,	1002,	NULL,	NULL,	1),
(2,	'Samsung Chromebooks',	1,	'',	NULL,	'<p>An ultraportable, sleek laptop for everyday adventures. It weighs 2.4 pounds and has over 6.5 hours of battery life, so you can bring it anywhere and use it everywheres</p>',	2,	'',	'',	'',	3,	1002,	NULL,	NULL,	NULL),
(3,	'Samsung Galaxy S4',	1,	'',	NULL,	'Hot news in smartphone world',	2,	'',	'',	'',	99,	1003,	NULL,	NULL,	NULL),
(4,	'Nokia 3310',	1,	'',	NULL,	'<p>Best smartphone of present smarthone world. SUPERB!!!</p>',	2,	'',	'',	'',	40,	1001,	NULL,	NULL,	NULL),
(5,	'Apple iPad',	3,	'',	NULL,	'Tablet from company Apple',	2,	'',	'',	'',	666,	1004,	NULL,	NULL,	NULL),
(6,	'Nokia 3310',	5,	'11111',	NULL,	'desc',	1,	'123456',	'122',	'rok',	1,	1002,	'0000-00-00',	0,	1),
(9,	'Apple iPad',	3,	'11111',	NULL,	'The best tablet EVER!',	2,	'123456',	'122',	'rok',	9,	1004,	'0000-00-00',	0,	1),
