...
(1003,	'Smartphones',	NULL,	NULL,	1001,	NULL),
...
CREATE TABLE `product` (
  ...
  `CategoryID` int(11) DEFAULT NULL,
  `DateOfAvailable` date DEFAULT '0000-00-00',
...
(1,	'Samsung Galaxy Nexus 2',	3,	'',	NULL,	'<p>Smartphone ze serie Nexus</p>',	1,	'',	'',	'',	10,	1002,	'0000-00-00',	NULL,	1),
(2,	'Samsung Chromebooks',	1,	'',	NULL,	'<p>An ultraportable, sleek laptop for everyday adventures. It weighs 2.4 pounds and has over 6.5 hours of battery life, so you can bring it anywhere and use it everywheres</p>',	2,	'',	'',	'',	3,	1002,	'0000-00-00',	NULL,	NULL),
(3,	'Samsung Galaxy S4',	1,	'',	NULL,	'Hot news in smartphone world',	2,	'',	'',	'',	99,	1003,	'0000-00-00',	NULL,	NULL),
(4,	'Nokia 3310',	1,	'',	NULL,	'<p>Best smartphone of present smarthone world. SUPERB!!!</p>',	2,	'',	'',	'',	40,	1001,	'0000-00-00',	NULL,	NULL),
(5,	'Apple iPad',	3,	'',	NULL,	'Tablet from company Apple',	2,	'',	'',	'',	666,	1004,	'0000-00-00',	NULL,	NULL),
...
(15,	'Asus Vivobook',	1,	'11111',	'',	'',	NULL,	'123456',	'122',	'rok',	10,	1002,	'0000-00-00',	2013,	1),
(16,	'Thinkpad',	1,	'11111',	'',	'',	NULL,	'123456',	'122',	'rok',	5,	1002,	'0000-00-00',	2013,	1);
...
(3,	'Contact us baby',	'Wau, this could be awesome contact text!',	2);
