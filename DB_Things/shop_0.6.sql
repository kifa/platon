...
CREATE TABLE `order` (
  ...
  KEY `Login` (`Login`),
  CONSTRAINT `order_ibfk_3` FOREIGN KEY (`Login`) REFERENCES `users` (`Login`),
  ...
  CONSTRAINT `order_ibfk_2` FOREIGN KEY (`Login`) REFERENCES `users` (`Login`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

INSERT INTO `order` (`OrderID`, `StatusID`, `Login`, `TotalPrice`, `TotalPriceTax`, `DateCreated`, `DateOfLastChange`, `DateFinished`, `DeliveryID`, `PaymentID`, `IP`, `SessionID`) VALUES
(1,	1,	NULL,	8999,	89,	'0000-00-00',	'0000-00-00',	'0000-00-00',	1,	1,	NULL,	NULL),
(2,	1,	NULL,	15999,	89,	'0000-00-00',	'0000-00-00',	'0000-00-00',	1,	2,	NULL,	NULL),
(3,	1,	NULL,	39997,	89,	'0000-00-00',	'0000-00-00',	'0000-00-00',	2,	1,	NULL,	NULL),
(4,	1,	NULL,	78993,	89,	'2013-03-26',	'0000-00-00',	'0000-00-00',	1,	1,	NULL,	NULL),
(5,	1,	NULL,	11999,	89,	'2013-03-26',	'2013-03-26',	NULL,	2,	1,	NULL,	NULL),
(6,	1,	NULL,	15999,	89,	'2013-03-26',	'2013-03-26',	NULL,	2,	2,	NULL,	NULL),
(7,	1,	NULL,	11999,	14518.8,	'2013-03-26',	'2013-03-26',	NULL,	1,	1,	NULL,	NULL);
...
INSERT INTO `users` (`Login`, `Password`, `Name`, `PhoneNumber`, `AddressID`, `CompanyName`, `TIN`, `Permission`) VALUES
('admin@admin.com',	'$2a$07$nta28l2g7n9ld4le56xpgeq',	'Admin',	0,	1,	'0',	'0',	'admin'),
('jan.novak@company.com',	'novak',	'Jan',	999888777,	2,	'Company',	'819281293',	'0'),
('kifa@mail.com',	'$2a$07$wllhgar90ofg24nsaywd3u2',	'Kifa',	NULL,	NULL,	NULL,	NULL,	'0'),
