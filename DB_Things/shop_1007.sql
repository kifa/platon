...
(1001,	'Cellphone',	'<p>A mobile phone (also known as a cellular phone, cell phone, and a hand phone) is a device that can make and receive telephone calls over a radio link while moving around a wide geographic area.&nbsp;</p>',	1,	NULL,	NULL),
(1002,	'Notebook',	'<p>A laptop computer is a personal computer for mobile use.[1] A laptop has most of the same components as a desktop computer, inclu<strong>ding a display, a keyboard, a pointing device such as a touchpad (also k</strong>nown as a trackpad) and/or a pointing stick, and speakers into a single unit. A laptop is powered by mains electricity via an AC adapter, and can be used away from an outlet using a rechargeable battery. Laptops are also sometimes called notebook computers, notebooks, ultrabooks[2] or netbooks. s</p>',	1,	NULL,	NULL),
...
(1,	'Samsung Galaxy Nexus 2',	3,	'',	NULL,	'<p>Smartphone ze serie Nexus</p>',	1,	'',	'',	'',	10,	1002,	'0000-00-00',	'0000-00-00',	1),
(2,	'Samsung Chromebooks',	1,	'',	NULL,	'<p>An ultraportable, sleek laptop for everyday adventures. It weighs 2.4 pounds and has over 6.5 hours of battery life, so you can bring it anywhere and use it everywheres</p>',	2,	'',	'',	'',	3,	1002,	'0000-00-00',	'0000-00-00',	NULL),
