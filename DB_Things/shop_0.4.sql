...
INSERT INTO `addresses` (`AdressID`, `Street`, `ZIPCode`, `City`, `State`) VALUES
...
INSERT INTO `users` (`Email`, `Password`, `Name`, `PhoneNumber`, `AddressID`, `CompanyName`, `TIN`, `Permission`) VALUES
