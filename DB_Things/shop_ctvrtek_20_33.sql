...
ON DUPLICATE KEY UPDATE `ProductID` = VALUES(`ProductID`), `ProductName` = VALUES(`ProductName`), `Producer` = VALUES(`Producer`), `ProductNumber` = VALUES(`ProductNumber`), `ProductDescription` = VALUES(`ProductDescription`), `ProductStatusID` = VALUES(`ProductStatusID`), `ProductEAN` = VALUES(`ProductEAN`), `ProductQR` = VALUES(`ProductQR`), `ProductWarranty` = VALUES(`ProductWarranty`), `PiecesAvailable` = VALUES(`PiecesAvailable`), `CategoryID` = VALUES(`CategoryID`), `DateOfAvailable` = VALUES(`DateOfAvailable`), `ProductDateOfAdded` = VALUES(`ProductDateOfAdded`), `CommentID` = VALUES(`CommentID`);
...
('admin@admin.com',	'$2a$07$$$$$$$$$$$$$$$$$$$$$$.Yqgs4IC6X2x/em6hm8RFU1wBrsCvoAi',	'Admin',	0,	1,	'0',	'0',	'admin'),
